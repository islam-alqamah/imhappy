...
//*Excellent Data*//
    ...
    public function pdf_dashboard2(){
        $team = Team::find(currentTeam()->id);
        $forms = $team->forms;
        $responses = FeedbackResponse::whereIn('form_id',$forms->pluck('id')->toArray())->orderByDesc('created_at')->paginate(10);
        $allresponses = FeedbackResponse::whereIn('form_id',$forms->pluck('id')->toArray())->orderByDesc('created_at')->get();
...
//        return view('pdf_dashboard',compact('team','total_average','total_excellent',
//            'total_poor','allresponses','total_responses','responses','forms','excellent','average','poor'));

        $pdf = PDF::loadView('pdf_dashboard',compact('team','total_average','total_excellent',
            'total_poor','allresponses','total_responses','responses','forms','excellent','average','poor'));
...
//        }
    ...
    public function pdf_dashboard(Request $request){
        ...
        Mail::send('emails.report', $data, function($message) {
            ...
            ('Your Account Monthly Report');
            $message->attach(public_path('/pdf_docs/1630354419.pdf')->getRealPath(),[
                'as' => 'report.pdf',
                'mime' => 'application/pdf',
            ]);
            $message->from('reporting@imhappy.sa',"I'M Happy");
...
//
////
//        $pdf = PDF::loadView('pdf_charts',compact('request','cities','branches','team',
//            'total_responses','excellent','excellent_h','excellent_d','excellent_m',
//            'average','average_h','average_d','average_m'
//            ,'poor','poor_h','poor_d','poor_m'));
...
//        //*Poor Data*//
//        return view('pdf_charts',compact('request','cities','branches','team',
//            'total_responses','excellent','excellent_h','excellent_d','excellent_m',
//            'average','average_h','average_d','average_m'
//            ,'poor','poor_h','poor_d','poor_m'));
