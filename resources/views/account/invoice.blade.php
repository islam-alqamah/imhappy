                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-4 text-right">
                                ...
                                <address class="mb-15">
                                    <span class="address-head mb-5">{{ currentTeam()->settings->company_name }}</span>
                                    {{ currentTeam()->settings->address }}<br/>
                                    <abbr title="Phone">P:</abbr>{{ currentTeam()->settings->phone }}
                                </address>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <address>
                                    ...
                                    {{ currentTeam()->settings->reporting_email }}
                                </address>
                            </div>
