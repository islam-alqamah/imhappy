                        ...
                        <div class="btn-group">
                            <div class="dropup ">
                                ...
                                <ul role="menu" class="dropdown-menu">
                                    ...
                                    <li><a target="_blank" href="{{ route('branches.points.export') }}">{{ __('Download Example File') }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div id="import-form" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h5 class="modal-title" id="myModalLabel">{{ __('Import Points') }} </h5>
                </div>
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="{{ route('branches.points.import') }}" method="post">
                        @csrf
