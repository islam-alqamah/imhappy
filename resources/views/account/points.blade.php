        ...
        <div class="col-md-12 mt-20">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">{{ $branch->name }} > {{ __('Points ') }}</h6>
                    </div>
                    <div class="pull-right">
                        <a href="{{ route('branches.points.editor',['point'=>'new','branch'=>$branch->id]) }}" class="btn btn-primary btn-outline fancy-button btn-0 btn-xs">
